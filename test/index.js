...
test.serial('basic test', async t => {
  ...
  t.deepEqual(Object.keys(metrics).sort(), ['ttfb', 'load', 'dcl', 'fcp', 'fid', 'cls', 'lcp'].sort())
  ...
  t.deepEqual(Object.keys(deviceInfo).sort(), ['url', 'userAgent', 'memory', 'connectionType', 'cpus'].sort())
